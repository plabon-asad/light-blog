 ...
 */
class light_blog_Tabbed_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'light_blog_tabbed_widget', esc_html__( 'CB: Tabbed Widget', 'creative-blog' ), // Name of the widget
			array(
				...
				<?php while ( $get_popular_posts->have_posts() ) : $get_popular_posts->the_post(); ?>
					<div class="single-article">
						...
						<div class="entry-meta">
							<?php light_blog_entry_meta_custom(); ?>
						</div>
					</div>
				<?php
				endwhile;
...
class light_blog_Random_Posts_Widget extends WP_Widget {

	function __construct() {
		parent::__construct(
			'light_blog_random_posts_widget', esc_html__( 'CB: Random Posts Widget', 'creative-blog' ), // Name of the widget
			array(
